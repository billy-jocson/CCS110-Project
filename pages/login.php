...
<body class="h-screen overflow-hidden bg-gray-50">
    ...
    <div class="hidden" id="loading">
        <div class="fixed inset-0 flex flex-col items-center justify-center z-50 bg-black/10">
            <div class="h-8 w-8 animate-spin rounded-full border-4 border-solid border-zinc-700 border-t-transparent">
            </div>
            <p>Loading...</p>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center h-full p-5 gap-5">
        ...
        <div class="flex-1 flex flex-col justify-center px-20 gap-5">
            ...
            <form class="flex flex-col gap-2" id="formLogin" method="POST">
